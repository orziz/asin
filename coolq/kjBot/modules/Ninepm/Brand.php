...
class Brand {
    ...
    private static $s = [
        ...
        "11" => ['text'=>'黑桃J','value'=>10],
        "12" => ['text'=>'黑桃Q','value'=>10],
        "13" => ['text'=>'黑桃K','value'=>10],
        "14" => ['text'=>'红桃A','value'=>1],
        "15" => ['text'=>'红桃2','value'=>2],
        "16" => ['text'=>'红桃3','value'=>3],
        "17" => ['text'=>'红桃4','value'=>4],
        ...
        "24" => ['text'=>'红桃J','value'=>10],
        "25" => ['text'=>'红桃Q','value'=>10],
        "26" => ['text'=>'红桃K','value'=>10],
        "27" => ['text'=>'梅花A','value'=>1],
        "28" => ['text'=>'梅花2','value'=>2],
        "29" => ['text'=>'梅花3','value'=>3],
        "30" => ['text'=>'梅花4','value'=>4],
        ...
        "37" => ['text'=>'梅花J','value'=>10],
        "38" => ['text'=>'梅花Q','value'=>10],
        "39" => ['text'=>'梅花K','value'=>10],
        "40" => ['text'=>'方块A','value'=>1],
        "41" => ['text'=>'方块2','value'=>2],
        "42" => ['text'=>'方块3','value'=>3],
        "43" => ['text'=>'方块4','value'=>4],
        ...
        "50" => ['text'=>'方块J','value'=>10],
        "51" => ['text'=>'方块Q','value'=>10],
        "52" => ['text'=>'方块K','value'=>10]
    ];
